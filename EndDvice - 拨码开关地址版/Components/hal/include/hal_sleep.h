...
extern uint8 sleepMode;						// 开机联网睡眠或是采集睡眠
#define FREE_SLEEP 0
#define START_SLEEP 1					// 开机联网失败睡眠
#define DATA_SLEEP 2					// 采集数据睡眠
#define DEFAULT_START_SLEEP_TIME 5000
extern uint32 startSleepTime;				// 开机联网失败的睡眠时间
extern uint32 Time_Interval;         //数据采集间隔
