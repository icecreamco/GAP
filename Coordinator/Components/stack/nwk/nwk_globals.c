...
uint16 *Cskip;
  ...
  uint8 CskipChldrn[MAX_NODE_DEPTH+1] = {20,20,20,20,20,20};
...
//  uint8 CskipChldrn[MAX_NODE_DEPTH+1] = {5,5,5,5,5,0};
  ...
  uint8 CskipChldrn[MAX_NODE_DEPTH+1] = {32,0};
...
//*****************∂œÕ¯÷ÿ∆Ù***************************************************//
#if defined (AUTO_RESET)                      //∫Í∂®“Â
  switch ( statusCode )                          
  {
    case NWK_ERROR_ASSOC_CNF_DENIED:          //∂œÕ¯ 
      SystemReset();                          //÷ÿ∆Ù
      break;
    default:break; 
  }
